# This structure is form  https://github.com/fyu/drn
...
class DRN(nn.Module):
    def time_to_coordinates(self, time):
        angle = time * 2 * math.pi / 24
        return math.sin(angle), math.cos(angle)

    def get_time_block(self, time, batch_size, height, width):
        x, y = self.time_to_coordinates(time)
